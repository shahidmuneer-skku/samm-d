...
class S3PRL(nn.Module):
    ...
    def forward(self, x):
        ...
        print("x len",x.size(),x_lens) # expected: torch.Size([batch, 64000])
...
if __name__ == "__main__":
    ...
    model = SAMMDModel(frontend="mms", device="cpu")
    _, output = model(x[0])
    print(output.shape) # expected: torch.Size([4, 2])
    
    # print("Testing Spectrogram Encoder")
    # model = SAMMDModel(frontend="spectrogram", device="cpu")
    # _, output = model(x)
    # print(output.shape) # expected: torch.Size([4, 1])
    
    # print("Testing Mel-Spectrogram Encoder")
    # model = SAMMDModel(frontend="mel-spectrogram", device="cpu")
    # _, output = model(x)
    # print(output.shape) # expected: torch.Size([4, 1])
    
    # print("Testing LFCC Encoder")
    # model = SAMMDModel(frontend="lfcc", device="cpu")
    # _, output = model(x)
    # print(output.shape) # expected: torch.Size([4, 1])
    
    # print("Testing MFCC Encoder")
    # model = SAMMDModel(frontend="mfcc", device="cpu")
    # _, output = model(x)
    # print(output.shape) # expected: torch.Size([4, 1])