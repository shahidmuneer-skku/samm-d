...
class AASIST(nn.Module):
    def __init__(self, device):
        ...
        self.lstm = nn.LSTM(input_size=512, hidden_size=128, batch_first=True, bidirectional=True)
        # self.lstm1 = nn.LSTM(512,256,bidirectional=True, batch_first=True)
        self.dropout = nn.Dropout(0.2)
        self.out_layer = nn.Linear(128*2, 1)  # 256*2 because the LSTM is bidirectional
